...
class ProfileFromSearch extends StatefulWidget{

  final searchuser;
  ProfileFromSearch(this.searchuser);

  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return ProfileFromSearchState();
  }

}

class ProfileFromSearchState extends State<ProfileFromSearch> {
  ...
  void initState(){
    super.initState();
      Usermanagement().getuserposts(widget.searchuser['username']).then((results) {
        setState(() {
          profilepic = widget.searchuser['profilepic'];
            ...
            Padding(
              ...
              child: Row(
                children: <Widget>[
                  ...
                  Column(
                    children: <Widget>[
                      Text(username == null?'usernname':username,
...
//              ),
//            ),
                posts == null?Center(child: Text('Loading...'),):Column(
